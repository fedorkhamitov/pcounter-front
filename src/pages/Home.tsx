...
const Home: React.FC = () => (
  <div style={{
    ...
    <Link to="/products" style={{ textAlign: "center", textDecoration: "none" }}>
      <img src="/pcounter-front/src/assets/products-svg-logo.svg" alt="Продукты" width={120} height={120} />
      <div style={{ marginTop: 12, fontSize: 18, color: "#333" }}>Продукты</div>
    </Link>
    <Link to="/orders" style={{ textAlign: "center", textDecoration: "none" }}>
      <img src="/pcounter-front/src/assets/orders-svg-logo.svg" alt="Заказы" width={120} height={120} />
